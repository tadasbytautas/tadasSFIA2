...
docker build --no-cache -t tbytautas/service_2:latest ./Service_2
#Pushes new built image to docker hub
docker push tbytautas/service_2

#Build clean version of service_3 image
docker build --no-cache -t tbytautas/service_3:latest ./Service_3
#Pushes new built image to docker hub
docker push tbytautas/service_3

#Build clean version of service_4 image
docker build --no-cache -t tbytautas/service_4:latest ./Service_4
#Pushes new built image to docker hub
docker push tbytautas/service_4

#Build clean version of service_4 image
docker build --no-cache -t tbytautas/nginxsfia2:latest ./NGINX
#Pushes new built image to docker hub
